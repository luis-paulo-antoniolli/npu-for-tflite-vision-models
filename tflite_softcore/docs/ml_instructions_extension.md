...
Este documento descreve as extensões propostas para a ISA do softcore TensorFlow Lite, adicionando instruções especializadas para operações comuns em redes neurais.
