# Script Tcl para síntese e implementação do TFLite Softcore
# FPGA: XCKU5P-FFVB676-2-I

# Definir variáveis do projeto
set project_name "tflite_npu"
...
file copy -force ./tflite_npu.runs/impl_1/tflite_softcore.bit ./tflite_softcore.bit
